...
const default_page = "text-red-400 bg-white rounded-lg p-1 hover:bg-yellow-200";
const selected_page ="text-red-400 bg-green-200 rounded-lg p-1 hover:bg-yellow-200";
let current_page ="";
